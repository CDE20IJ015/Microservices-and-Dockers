...
<body>
	<header>
		...
		<nav>
			<a class="nav-link" href="./show-movie-list-customer">Movies</a> <a
				class="nav-link" href="./favorites">Favorites</a>
		</nav>
	</header>
	<article>
		<h2 class="article-heading">Favorites</h2>
		<p class="article-notification">Movie removed from Favorites
			successfully</p>
		<br>
		<table>
			<tr>
